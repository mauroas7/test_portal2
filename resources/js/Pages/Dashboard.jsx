        ...
        <div className="min-h-screen bg-primary p-3 font-sans antialiased lg:p-4 relative">
            ...
            <div className="mx-auto flex flex-col min-h-[calc(100vh-1.5rem)] w-full max-w-[1900px] overflow-hidden rounded-[2rem] bg-white shadow-2xl lg:min-h-[calc(100vh-2rem)]">
                ...
                <div className="flex flex-1 w-full min-h-[calc(100vh-1.5rem)] lg:min-h-[calc(100vh-2rem)]">
                    ...
                    {/* LADO DERECHO COMPLETO (Header Inamovible + Contenido Dinámico) */}
                    <div className="flex min-w-0 flex-1 flex-col bg-[#F4F7F9]">
                        
                        {/* HEADER: Ahora es 100% estructural. No se mueve jamás. */}
                            ...
                            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 w-full">
                                <div className="relative w-full max-w-2xl z-50">
                                    ...
                                    <input 
                                        ...
                                        className="w-full rounded-2xl border border-gray-100 bg-[#F4F7F9] py-3.5 pl-12 pr-12 text-sm font-semibold text-primary transition-all placeholder:text-gray-400 focus:bg-white focus:ring-2 focus:ring-secondary/20 focus:border-secondary/20 shadow-inner" 
                                    />
                                    {globalSearch && (
                                        <button 
                                ...
                                {/* PERFIL DEL USUARIO - Fijo en la esquina superior derecha */}
                        ...
                        {/* CUERPO CENTRAL: Sección Principal + Barra Lateral Derecha Condicional */}
                        <div className="flex flex-1 relative">
                            
                            {/* ZONA DE CONTENIDO DINÁMICO (Se expande si no hay barra derecha) */}
                                            ...
                                            <div className="w-full">
                                                <div className="rounded-[2rem] bg-white p-6 sm:p-8 shadow-sm h-full flex flex-col border border-gray-100">
                                                    ...
                                                    <div className="space-y-4 flex-1">
                                                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4 rounded-2xl border border-gray-100 bg-white shadow-sm p-4 transition-all hover:border-secondary/30 hover:shadow-md cursor-pointer">
                                ...
                                {tab === 'turnos' && (
                                    <div className="w-full animate-fade-in">
                                        ...
                                        <div className="mb-8 flex p-1.5 bg-white shadow-sm w-fit rounded-xl border border-gray-100">
                                            <button onClick={() => setSubTabTurnos('proximos')} className={`px-6 py-2.5 rounded-lg text-[11px] font-black uppercase tracking-widest transition-all ${subTabTurnos === 'proximos' ? 'bg-[#F4F7F9] text-primary shadow-inner border border-gray-100' : 'text-gray-400 hover:text-brandText'}`}>
                                                Próximos Turnos
                                            </button>
                                            <button onClick={() => setSubTabTurnos('historial')} className={`px-6 py-2.5 rounded-lg text-[11px] font-black uppercase tracking-widest transition-all ${subTabTurnos === 'historial' ? 'bg-[#F4F7F9] text-primary shadow-inner border border-gray-100' : 'text-gray-400 hover:text-brandText'}`}>
                                                            ...
                                                            <div key={turno.id} className="grid gap-4 border-b border-gray-50 px-6 py-6 transition-colors hover:bg-[#F4F7F9] lg:grid-cols-5 lg:items-center lg:px-10">
                                                                ...
                                                                <div className="flex justify-start lg:justify-end">
                                                                    <button 
                                                                        ...
                                                                        className="group flex w-full lg:w-auto items-center justify-center gap-2 rounded-xl border border-gray-200 bg-white px-5 py-2.5 text-[10px] font-black uppercase tracking-widest text-gray-500 transition-all duration-300 hover:border-red-200 hover:bg-red-50 hover:text-red-600 shadow-sm hover:shadow-md"
                                                                    >
                                                        ...
                                                        {turnosPasados.map((turno) => (
                                                            <div key={turno.id} className="grid gap-4 border-b border-gray-50 px-6 py-6 transition-colors hover:bg-[#F4F7F9] lg:grid-cols-4 lg:items-center lg:px-10 opacity-70 hover:opacity-100">
                                                                ...
                                                                <div className="flex flex-wrap lg:justify-end gap-2 mt-2 lg:mt-0">
                                                                    <button className="text-[10px] font-black uppercase tracking-widest text-secondary hover:underline flex items-center gap-1 bg-white border border-gray-200 px-4 py-2 rounded-xl shadow-sm hover:shadow-md transition-all">
                                ...
                                {tab === 'salud' && (
                                    <div className="w-full animate-fade-in">
                                        ...
                                        <div className="mb-8 flex p-1.5 bg-white shadow-sm w-fit rounded-xl border border-gray-100 overflow-x-auto max-w-full">
                                            <button onClick={() => setSubTabSalud('resultados')} className={`whitespace-nowrap px-6 py-2.5 rounded-lg text-[11px] font-black uppercase tracking-widest transition-all ${subTabSalud === 'resultados' ? 'bg-[#F4F7F9] text-primary shadow-inner border border-gray-100' : 'text-gray-400 hover:text-brandText'}`}>
                                                Resultados y Estudios
                                            </button>
                                            <button onClick={() => setSubTabSalud('recetas')} className={`whitespace-nowrap px-6 py-2.5 rounded-lg text-[11px] font-black uppercase tracking-widest transition-all ${subTabSalud === 'recetas' ? 'bg-[#F4F7F9] text-primary shadow-inner border border-gray-100' : 'text-gray-400 hover:text-brandText'}`}>
                                                Mis Recetas
                                            </button>
                                            <button onClick={() => setSubTabSalud('perfil')} className={`whitespace-nowrap px-6 py-2.5 rounded-lg text-[11px] font-black uppercase tracking-widest transition-all ${subTabSalud === 'perfil' ? 'bg-[#F4F7F9] text-primary shadow-inner border border-gray-100' : 'text-gray-400 hover:text-brandText'}`}>
                                                Perfil Clínico
                                            </button>
                                        </div>
                                        ...
                                        {subTabSalud === 'recetas' && (
                                            /* UX: Ahora usa 3 columnas en pantallas extra grandes por el espacio ganado */
                                ...
                                <div className="w-full animate-fade-in">
                                    ...
                                    <div className="mb-8 flex p-1.5 bg-white shadow-sm w-fit rounded-xl border border-gray-100">
                                        <button 
                                            ...
                                            className={`px-6 py-2.5 rounded-lg text-[11px] font-black uppercase tracking-widest transition-all ${subTabCartilla === 'especialidades' ? 'bg-[#F4F7F9] text-primary shadow-inner border border-gray-100' : 'text-gray-400 hover:text-brandText'}`}
                                        >
                                            Especialidades
                                        </button>
                                        <button 
                                            onClick={() => setSubTabCartilla('profesionales')} 
                                            className={`px-6 py-2.5 rounded-lg text-[11px] font-black uppercase tracking-widest transition-all ${subTabCartilla === 'profesionales' ? 'bg-[#F4F7F9] text-primary shadow-inner border border-gray-100' : 'text-gray-400 hover:text-brandText'}`}
                                        >
                                            Profesionales A-Z
                                        </button>
                                    </div>
                                    ...
                                    {subTabCartilla === 'especialidades' && (
                                        /* UX: Ahora usa 5 columnas en pantallas extra grandes (xl:grid-cols-5) */
                                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6 animate-fade-in">
                                            {especialidades_db.map(esp => (
                                                <div key={esp.id} className="group flex cursor-pointer flex-col justify-between overflow-hidden rounded-[2rem] border border-gray-100 bg-white p-6 shadow-sm transition-all hover:-translate-y-1 hover:border-secondary/30 hover:shadow-md">
                                    ...
                                    {subTabCartilla === 'profesionales' && (
                                        <div className="animate-fade-in">
                                            <div className="mb-8 flex flex-col md:flex-row gap-4 rounded-2xl bg-white shadow-sm border border-gray-100 p-4">
                                                <div className="w-full md:w-1/2 lg:w-1/3">
                                                    ...
                                                    <select 
                                                        ...
                                                        className="w-full rounded-xl border border-gray-100 bg-[#F4F7F9] py-3 pl-4 pr-10 text-sm font-bold text-primary outline-none focus:ring-2 focus:ring-secondary/20 appearance-none cursor-pointer"
                                                    >
                                            ...
                                            {/* UX: Ahora usa 3 columnas en pantallas grandes (lg:grid-cols-3) */}
                                                        ...
                                                        <div key={prof.id} className="flex flex-col sm:flex-row gap-6 overflow-hidden rounded-[2rem] border border-gray-100 bg-white p-6 shadow-sm transition-shadow hover:shadow-md">
                                                            ...
                                                            <div className="flex flex-1 flex-col justify-between">
                                                                ...
                                                                <div className="mt-4 flex gap-3">
                                                                    <button className="flex-1 rounded-xl border border-gray-200 bg-white shadow-sm px-2 py-2.5 text-[10px] font-black uppercase tracking-widest text-primary transition-colors hover:bg-[#F4F7F9] text-center">
                                                                        Ver Perfil
                                                                    </button>
                                                                    <button onClick={() => {
                                                                        ...
                                                                        setModalStep(3);
                                                                        setIsModalOpen(true);
                                                                    }} className="flex-1 rounded-xl bg-primary shadow-sm px-2 py-2.5 text-[10px] font-black uppercase tracking-widest text-white transition-colors hover:bg-blue-900 text-center">
                                                                        Sacar Turno
                                                                    </button>
                                                                </div>
                                                            </div>
                                ...
                                {tab === 'documentos' && (
                                    <div className="w-full animate-fade-in">
                                        <div className="mb-8 flex flex-col md:flex-row items-start md:items-end justify-between gap-6 border-b border-gray-100 pb-6">
                                            ...
                                            <button className="group flex w-full md:w-auto shrink-0 items-center justify-center gap-3 rounded-full bg-primary px-8 py-4 text-[12px] font-black uppercase tracking-widest text-white shadow-lg shadow-primary/30 transition-all duration-300 hover:-translate-y-1 hover:bg-[#002a5c]">
                                                <span className="material-symbols-outlined text-[24px] transition-transform group-hover:-translate-y-1">cloud_upload</span>
                                                Subir Archivo
                                            </button>
                                        </div>

                                        {/* UX: Ahora usa 4 columnas en pantallas extra grandes */}
                                        <div className="mb-10 grid grid-cols-1 md:grid-cols-3 xl:grid-cols-4 gap-6">
                                            <div className="group cursor-pointer rounded-[2rem] border border-gray-100 bg-white p-6 shadow-sm transition-all hover:border-secondary/30 hover:shadow-md">
                            ...
                            {/* BARRA LATERAL DERECHA (Solo existe cuando tab === 'inicio') */}
                            {tab === 'inicio' && (
        ...
        >
            ...
            >
                ...
                <div className="flex shrink-0 items-center justify-between border-b border-gray-100 bg-[#F4F7F9] px-8 py-6">
                    ...
                    <button onClick={onClose} className="flex h-12 w-12 items-center justify-center rounded-full bg-white shadow-sm text-gray-500 transition-all hover:bg-red-50 hover:text-red-500 border border-gray-100">
                        ...
                        <div className="animate-fade-in mx-auto w-full">
                            <div className="relative mb-8 mx-auto max-w-3xl">
                                ...
                                <input 
                                    ...
                                    className="w-full rounded-2xl border-2 border-gray-100 bg-[#F4F7F9] py-4 pl-16 pr-6 text-base font-bold text-primary transition-all placeholder:text-gray-400 focus:border-secondary/50 focus:bg-white focus:outline-none shadow-inner" 
                                />
                            </div>
                            ...
                            <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
                                {medicosFiltrados.length > 0 ? (
                                    medicosFiltrados.map((prof) => (
                                        ...
                                        >
                                            <div className={`flex h-16 w-16 shrink-0 items-center justify-center rounded-full border-2 ${turnoData.medico_id === prof.id ? 'border-secondary bg-secondary text-white' : 'border-primary bg-white shadow-sm text-primary'}`}>
                                                ...
                                                <div className="flex flex-wrap gap-3">
                                                    {['09:00', '09:30', '10:15', '11:00'].map(hora => (
                                                        <button 
                                                            ...
                                                            className={`rounded-xl border px-5 py-2.5 text-sm font-black transition-all ${turnoData.hora === hora ? 'border-secondary bg-secondary text-white shadow-md' : 'border-gray-200 bg-[#F4F7F9] text-primary hover:border-secondary hover:bg-white'}`}
                                                        >
                                                            {hora}
                                                        </button>
                                                    ))}
                    ...
                    {step === 4 && (
                        <div className="animate-fade-in mx-auto w-full max-w-4xl py-2">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 mb-10 text-left">
                                <div className="rounded-[24px] border border-gray-100 bg-white p-6 lg:p-8 shadow-sm transition-all hover:shadow-md flex flex-col">
                ...
                <div className="shrink-0 border-t border-gray-100 bg-white px-8 py-5 flex items-center justify-between">
                    ...
                    {step < 4 ? (
                        ...
                        <button 
                            ...
                            className="flex items-center gap-2 rounded-full bg-emerald-500 px-8 py-3 text-xs font-black uppercase tracking-widest text-white transition-all hover:bg-emerald-600 shadow-lg shadow-emerald-500/30 hover:-translate-y-1"
                        >
